<?php
	...
	if ($run == 1) {
		...
		$lives_remaining = 3;
		$target_score = 30;
		$sql = "INSERT INTO game (game_status, game_fishing_line_strength, game_lives_remaining, game_target_score)
		VALUES (:game_status, :fishing_line_strength, :remaining_lives, :target_score)";
		$stmt = $conn->prepare($sql);
		$stmt->execute([
			':game_status' => 'started',
			':fishing_line_strength' => 4,
